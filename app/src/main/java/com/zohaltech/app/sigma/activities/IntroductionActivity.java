...
public class IntroductionActivity extends BazaarPaymentActivity {
    ...
    void onCreated() {
        ...
        texts = new String[]{"به " + getString(R.string.app_name) + " خوش آمدید\nبرنامه ای برای مدیریت و کنترل مصرف بسته های اینترنتی و گزارشات مصرف روزانه",
                             ...
                             "استفاده از سیگما با تمامی امکانات، به مدت یک هفته رایگان است و پس از آن میبایست از طریق پرداخت درون برنامه ای، نسخه کامل و بدون محدودیت را خریداری نمایید.",
        };
