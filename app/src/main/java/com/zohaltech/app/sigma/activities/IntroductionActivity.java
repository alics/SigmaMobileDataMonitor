...
public class IntroductionActivity extends PaymentActivity {
    ...
    void onCreated() {
        ...
        texts = new String[]{"به " + getString(R.string.app_name) + " خوش آمدید\nبرنامه ای برای مدیریت و کنترل مصرف بسته های اینترنتی و گزارشات مصرف روزانه",
                             ...
                             "سرعت اینترنت موبایل و مصرف روز جاری و همچنین هشدارهای سیگما را در نوار اعلان(Notification) مشاهده کنید.",
                             "گزارش مصرف اینترنت 30 روز گذشته به تفکیک روز و مجموع ترافیک مصرفی را مشاهده کنید.",
                             "استفاده از سیگما با تمامی امکانات، به مدت دو روز رایگان است و پس از آن بخش های خرید بسته و مدیریت بسته غیرفعال خواهند شد و میبایست از طریق پرداخت درون برنامه ای، نسخه کامل و بدون محدودیت را خریداری نمایید.",
        };
